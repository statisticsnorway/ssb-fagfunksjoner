...
def tests(session: Session) -> None:
    """Run the test suite."""
    session.install(".")
    session.install("coverage[toml]", "pytest", "pygments", "responses", "pytest-mock")
    try:
        session.run(
            "coverage",
            "run",
...
def typeguard(session: Session) -> None:
    ...
    session.install(".")
    session.install("pytest", "typeguard", "pygments", "responses", "pytest-mock")
