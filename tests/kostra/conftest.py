...
def mock_klass_classification():
    with patch('fagfunksjoner.kostra.kostra_kommunekorr.KlassClassification') as MockKlassClassification:
...
def mock_klass_correspondence():
    MockKlassCorrespondence = patch('fagfunksjoner.kostra.kostra_kommunekorr.KlassCorrespondence')
    
    def mock_init(self, source_classification_id, target_classification_id, from_date, to_date):
