...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016-01-01"), (dt.date(2022, 6, 1), "2022-06-01")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016-01"), (dt.date(2022, 6, 1), "2022-06")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016"), (dt.date(2022, 6, 1), "2022")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2015W53"), (dt.date(2022, 6, 1), "2022W22")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016-001"), (dt.date(2022, 6, 1), "2022-152")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016-Q1"), (dt.date(2022, 6, 1), "2022-Q2")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016-B1"), (dt.date(2022, 6, 1), "2022-B3")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016-T1"), (dt.date(2022, 6, 1), "2022-T2")],
)
...
@pytest.mark.parametrize(
    "date_input,exprected_string",
    [(dt.date(2016, 1, 1), "2016-H1"), (dt.date(2022, 6, 1), "2022-H1")],
)
